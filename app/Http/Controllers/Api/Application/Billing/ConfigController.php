...
class ConfigController extends ApplicationApiController
{
    ...
    public function export(ExportBillingConfigRequest $request): StreamedResponse
    {
        $data = [
            'export_info' => [
                'warning' => 'This file was automatically generated by Zero-Bot. Do NOT edit this file unless you know what you are doing.',
        ...
        Activity::event('admin:billing:config:export')
            ->description('User exported Zero-Bot billing configuration')
            ->log();
    ...
    /**
     * Import a billing configuration file to Zero-Bot.
     *
     * @throws \Throwable
     */
    public function import(ImportBillingConfigRequest $request): Response
    {
        ...
        Activity::event('admin:billing:config:import')
            ...
            ->description('User imported Zero-Bot billing configuration')
            ->log();
