...
export default () => {
    ...
    return (
        <Dialog open onClose={() => undefined} preventExternalClose hideCloseIcon title={'Configure Zero-Bot AI'}>
            <SpinnerOverlay visible={loading} />
            <p className={'text-gray-400'}>
                In order to use <span style={{ color: theme.primary }}>Zero-Bot AI</span>, you must get a Gemini API key
                from Google.
            </p>
