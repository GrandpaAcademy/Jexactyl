        ...
        <div className={'grid lg:grid-cols-5 gap-4'}>
            <div className={'col-span-3'}>
                ...
                <div className={'w-full bg-zinc-800 rounded-b px-4 py-2 inline-flex'}>
                    ...
                    <Input className={'font-mono'} placeholder={'Ask Zero-Bot AI a question'} onKeyDown={submit} />
                </div>
            </div>
            <div className={'col-span-2 space-y-4'}>
                <Alert type={'warning'} className={'mt-16 md:mt-0'}>
                    Zero-Bot AI relies on Google Gemini models for requests. Information provided could be inaccurate or
                ...
                <AdminBox title={'Disable Zero-Bot AI'} className={'col-span-2 h-min'}>
                    Clicking the button below will disable Zero-Bot AI for both clients and administrators. Your API key
